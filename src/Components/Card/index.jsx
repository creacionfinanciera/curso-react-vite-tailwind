    ...
    return (
        <div className="bg-white w-56 h-60 cursor-pointer rounded-lg">
            <figure className="relative mb-2 w-full h-4/5">
                ...
                <img className="w-full h-full object-cover rounded-lg" src="https://images.pexels.com/photos/1037992/pexels-photo-1037992.jpeg?auto=compress&cs=tinysrgb&w=800" alt="headphones" />
